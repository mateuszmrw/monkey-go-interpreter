...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.CallExpression:
		...
		args := evalExpressions(node.Arguemnts, env)
...
func evalHashLiteral(node *ast.HashLiteral, env *object.Environment) object.Object {
	...
	for keyNode, keyValue := range node.Paris {
...
func evalStringIndexExpression(str, index object.Object) object.Object {
	...
	return &object.Byte{Value: stringObject.Value[idx]}
}
...
func evalIdentifier(ie *ast.Identifier, env *object.Environment) object.Object {
	...
	if bultin, ok := builtins[ie.Value]; ok {
		return bultin
	}
